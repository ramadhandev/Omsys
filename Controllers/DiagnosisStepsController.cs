...
namespace OMSys.Controllers
{
    ...
    public class DiagnosisStepsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.DiagnosisSteps.Include(d => d.Symptom);
        ...
        public async Task<IActionResult> Create([Bind("StepId,SymptomId,StepOrder,Instruction")] DiagnosisStep diagnosisStep)
        {
            ...
            ViewData["SymptomId"] = new SelectList(_context.Symptoms, "SymptomId", "SymptomId", diagnosisStep.SymptomId);
            return View(diagnosisStep);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StepId,SymptomId,StepOrder,Instruction")] DiagnosisStep diagnosisStep)
        {
